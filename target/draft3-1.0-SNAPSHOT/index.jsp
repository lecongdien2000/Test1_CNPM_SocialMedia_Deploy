...
<head>
    ...
    <title>Mạng xã hội Pitnik</title>
        ...
        <div class="top-area">
            ...
            <div class="top-search">
                <form method="post" class="">
                    <input type="text" placeholder="Tìm kiếm người, trang, nhóm,...">
                        ...
                        <div class="row merged20" id="page-contents">
                                ...
                                <aside class="sidebar static left">
                                    <div class="widget">
                                        <div class="weather-widget low-opacity bluesh">
                                            ...
                                            <div class="weather-infos">
                                                ...
                                                <h3>Trời nhiều mây<i>Thủ Đức, TP.HCM</i></h3>
                                                <div class="weather-date skyblue-bg">
                                                    <span>Th.5<strong>21</strong></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="widget whitish low-opacity">
                                        ...
                                        <div class="dob-meta">
                                            ...
                                            <h6>Hôm nay là sinh nhật của <a href="#" title="">Lucy Carbel</a></h6>
                                            <p>hãy gửi lời chúc tốt đẹp cho cô ấy.</p>
                                        </div>
                                    </div><!-- birthday widget -->
                                    <div class="widget">
                                        ...
                                        <ul class="twiter-feed">
                                            <li>
                                                ...
                                                <p>tomorrow with the company we were working and 5 child run away from
                                                    the working place. <a href="#" title="">#daydream5k</a></p>
                                                <em>2 hours ago</em>
                                            </li>
                                            <li>
                                                <i class="fa fa-twitter"></i>
                            ...
                            <div class="col-lg-6">
                                <div class="central-meta postbox">
                                    ...
                                    <%---------%>
                                    <span class="create-post">Viết bài</span>
                                ...
                                <div class="central-meta">
                                    <span class="create-post">Bảng tin <a href="#" title="">Xem tất cả</a></span>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="stories-users">
                                                            <h5>Stories</h5>
                                                            <div class="my-status">
                                                                <figure><img src="images/resources/friend-avatar10.jpg"
                                                                             alt=""></figure>
                                                    ...
                                                    <div class="more">
                                                        <div class="more-post-optns"><i class="ti-more-alt"></i>
                                                            <ul>
                                                                ...
                                                                <li><i class="fa fa-address-card-o"></i>Boost This Post
                                                                </li>
                                                                <li><i class="fa fa-clock-o"></i>Schedule Post</li>
                                                                <li><i class="fa fa-wpexplorer"></i>Select as featured
                                                                </li>
                                                ...
                                                <div class="post-meta">
                                                    ...
                                                    <div class="we-video-info">
                                                        ...
                                                        <div class="users-thumb-list">
                                                            ...
                                                            <span><strong>Bạn</strong>, <b>Sarah</b> và <a href="#"
                                                                                                           title="">24 người khác </a> thích bài</span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <aside class="sidebar static right">
                                    <div class="widget">
                                        ...
                                        <div class="your-page">
                                            ...
                                            <div class="page-meta">
                                                <a href="#" title="" class="underline">Tổng hợp thời trang nam</a>
                                                <span><i class="ti-comment"></i><a href="insight.html" title="">Nhắn tin <em>9</em></a></span>
                                                <span><i class="ti-bell"></i><a href="insight.html"
                                                                                title="">Thông báo <em>2</em></a></span>
                                            </div>
                                            <ul class="page-publishes">
                                                <li>
                                                    <span><i class="ti-pencil-alt"></i>Xuất bản</span>
                                                </li>
                                                <li>
                                                    <span><i class="ti-camera"></i>Ảnh</span>
                                                </li>
                                                <li>
                                                    <span><i class="ti-video-camera"></i>Live</span>
                                                </li>
                                                <li>
                                                    <span><i class="fa fa-user-plus"></i>Mời</span>
                                                </li>
                                            </ul>
                                            <div class="page-likes">
                                                <ul class="nav nav-tabs likes-btn">
                                                    <li class="nav-item"><a class="active" href="#link1"
                                                                            data-toggle="tab" data-ripple="">Thích</a>
                                                    </li>
                                                    <li class="nav-item"><a class="" href="#link2" data-toggle="tab"
                                                                            data-ripple="">Xem</a></li>
                                                </ul>
                                                <!-- Tab panes -->
                                                <div class="tab-content">
                                                    <div class="tab-pane active fade show " id="link1">
                                                        <span><i class="ti-heart"></i>884</span>
                                                        <a href="#" title="weekly-likes">35 lượt thích mới trong
                                                            tuần</a>
                                                        <div class="users-thumb-list">
                                                    ...
                                                    <div class="tab-pane fade" id="link2">
                                                        ...
                                                        <a href="#" title="weekly-likes">440 lượt xem mới trong tuần</a>
                                                        <div class="users-thumb-list">
                                                            <a href="#" title="Anderw" data-toggle="tooltip">
                                                                <img src="images/resources/userlist-1.jpg" alt="">
                                                            </a>
                                    ...
                                    <div class="widget">
                                        <h4 class="widget-title">Sự kiện <a title="" href="#" class="see-all">Xem tất
                                            cả</a></h4>
                                        <div class="rec-events bg-purple">
                                            <i class="ti-gift"></i>
                                            <h6><a href="#" title="">Ngày hội đồng giá sách ở Thủ Đức</a></h6>
                                            <img src="images/clock.png" alt="">
                                        </div>
                                        <div class="rec-events bg-blue">
                                            <i class="ti-microphone"></i>
                                            <h6><a href="#" title="">Cuộc thi tài năng âm nhạc mùa 3</a></h6>
                                            <img src="images/clock.png" alt="">
                                        </div>
                                    </div><!-- explore events -->
                                    <div class="widget">
                                        ...
                                        <ul class="recent-links">
                                            <li>
                                                ...
                                                <div class="re-links-meta">
                                                    <h6><a href="#" title="">moira's fade reaches much farther than you
                                                        think.</a></h6>
                                            ...
                                            <li>
                                                ...
                                                <div class="re-links-meta">
                                                    <h6><a href="#" title="">daniel asks if we want him to do the voice
                                                        of doomfist</a></h6>
